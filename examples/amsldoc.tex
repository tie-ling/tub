...
%
\documentclass[leqno,titlepage,openany,a5paper]{amsldoc}[1999/12/13]
\usepackage{geometry}
\geometry{left=1cm,
  right=1cm,
  top=2cm,
...
%    examples.
\usepackage{unicode-math,parskip}
...
often to the complex numbers or real numbers in your document, you
might find this method more convenient than (let's say) defining a
\ncn{field} command and writing |\field{C}|, |\field{R}|. But for
