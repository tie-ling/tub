...
\usepackage{unicode-math,parskip,amsthm}
...
transmitted by  then, by the separate-transmissions property and
...
is the number of bits  must transmit in the worst case
